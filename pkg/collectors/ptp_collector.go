...
func (c BasicCallBack) Call(collectorName string, datatype string, line string) {
...
// Stops a running collector then should do clean up of
// which there is currently non
